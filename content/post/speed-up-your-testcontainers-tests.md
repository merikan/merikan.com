...
date: 2020-10-06T21:22:53+02:00
draft: true
author: Peter
...
This is all a great but but one thing that slows me down is that when I work with one test and want to run it several times, it takes a very long time and I want a fast feedback loop. So let's dig deeper and see how we can solve that.
